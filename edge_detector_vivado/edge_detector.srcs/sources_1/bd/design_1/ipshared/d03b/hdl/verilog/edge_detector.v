...
(* CORE_GENERATION_INFO="edge_detector,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z015clg485-2,HLS_INPUT_CLOCK=6.666000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.832750,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=13,HLS_SYN_FF=4829,HLS_SYN_LUT=9267}" *)
...
fifo_w8_d1_A sobelImg_data_stream_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A thresholdImg_data_st_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
