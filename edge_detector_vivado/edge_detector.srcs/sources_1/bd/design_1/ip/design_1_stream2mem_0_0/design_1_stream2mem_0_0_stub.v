...
// Date        : Fri Sep 21 16:35:05 2018
// Host        : Mei-PC running 64-bit Service Pack 1  (build 7601)
// Command     : write_verilog -force -mode synth_stub
//               F:/ax7020/2017/course_s3_hls/vivado/10_edge_detector/edge_detector.srcs/sources_1/bd/design_1/ip/design_1_stream2mem_0_0/design_1_stream2mem_0_0_stub.v
...
(* X_CORE_INFO = "stream2mem,Vivado 2017.4" *)
module design_1_stream2mem_0_0(s_axi_AXILiteS_AWADDR, 
  s_axi_AXILiteS_AWVALID, s_axi_AXILiteS_AWREADY, s_axi_AXILiteS_WDATA, 
  s_axi_AXILiteS_WSTRB, s_axi_AXILiteS_WVALID, s_axi_AXILiteS_WREADY, 
  s_axi_AXILiteS_BRESP, s_axi_AXILiteS_BVALID, s_axi_AXILiteS_BREADY, 
  s_axi_AXILiteS_ARADDR, s_axi_AXILiteS_ARVALID, s_axi_AXILiteS_ARREADY, 
  s_axi_AXILiteS_RDATA, s_axi_AXILiteS_RRESP, s_axi_AXILiteS_RVALID, 
  s_axi_AXILiteS_RREADY, ap_clk, ap_rst_n, m_axi_pMemPort_AWADDR, m_axi_pMemPort_AWLEN, 
  m_axi_pMemPort_AWSIZE, m_axi_pMemPort_AWBURST, m_axi_pMemPort_AWLOCK, 
  m_axi_pMemPort_AWREGION, m_axi_pMemPort_AWCACHE, m_axi_pMemPort_AWPROT, 
  m_axi_pMemPort_AWQOS, m_axi_pMemPort_AWVALID, m_axi_pMemPort_AWREADY, 
  m_axi_pMemPort_WDATA, m_axi_pMemPort_WSTRB, m_axi_pMemPort_WLAST, 
  m_axi_pMemPort_WVALID, m_axi_pMemPort_WREADY, m_axi_pMemPort_BRESP, 
  m_axi_pMemPort_BVALID, m_axi_pMemPort_BREADY, m_axi_pMemPort_ARADDR, 
  m_axi_pMemPort_ARLEN, m_axi_pMemPort_ARSIZE, m_axi_pMemPort_ARBURST, 
  m_axi_pMemPort_ARLOCK, m_axi_pMemPort_ARREGION, m_axi_pMemPort_ARCACHE, 
  m_axi_pMemPort_ARPROT, m_axi_pMemPort_ARQOS, m_axi_pMemPort_ARVALID, 
  m_axi_pMemPort_ARREADY, m_axi_pMemPort_RDATA, m_axi_pMemPort_RRESP, 
  m_axi_pMemPort_RLAST, m_axi_pMemPort_RVALID, m_axi_pMemPort_RREADY, vstream_TVALID, 
  vstream_TREADY, vstream_TDATA, vstream_TKEEP, vstream_TSTRB, vstream_TUSER, vstream_TLAST, 
  vstream_TID, vstream_TDEST, indexw, indexr)
/* synthesis syn_black_box black_box_pad_pin="s_axi_AXILiteS_AWADDR[5:0],s_axi_AXILiteS_AWVALID,s_axi_AXILiteS_AWREADY,s_axi_AXILiteS_WDATA[31:0],s_axi_AXILiteS_WSTRB[3:0],s_axi_AXILiteS_WVALID,s_axi_AXILiteS_WREADY,s_axi_AXILiteS_BRESP[1:0],s_axi_AXILiteS_BVALID,s_axi_AXILiteS_BREADY,s_axi_AXILiteS_ARADDR[5:0],s_axi_AXILiteS_ARVALID,s_axi_AXILiteS_ARREADY,s_axi_AXILiteS_RDATA[31:0],s_axi_AXILiteS_RRESP[1:0],s_axi_AXILiteS_RVALID,s_axi_AXILiteS_RREADY,ap_clk,ap_rst_n,m_axi_pMemPort_AWADDR[31:0],m_axi_pMemPort_AWLEN[7:0],m_axi_pMemPort_AWSIZE[2:0],m_axi_pMemPort_AWBURST[1:0],m_axi_pMemPort_AWLOCK[1:0],m_axi_pMemPort_AWREGION[3:0],m_axi_pMemPort_AWCACHE[3:0],m_axi_pMemPort_AWPROT[2:0],m_axi_pMemPort_AWQOS[3:0],m_axi_pMemPort_AWVALID,m_axi_pMemPort_AWREADY,m_axi_pMemPort_WDATA[31:0],m_axi_pMemPort_WSTRB[3:0],m_axi_pMemPort_WLAST,m_axi_pMemPort_WVALID,m_axi_pMemPort_WREADY,m_axi_pMemPort_BRESP[1:0],m_axi_pMemPort_BVALID,m_axi_pMemPort_BREADY,m_axi_pMemPort_ARADDR[31:0],m_axi_pMemPort_ARLEN[7:0],m_axi_pMemPort_ARSIZE[2:0],m_axi_pMemPort_ARBURST[1:0],m_axi_pMemPort_ARLOCK[1:0],m_axi_pMemPort_ARREGION[3:0],m_axi_pMemPort_ARCACHE[3:0],m_axi_pMemPort_ARPROT[2:0],m_axi_pMemPort_ARQOS[3:0],m_axi_pMemPort_ARVALID,m_axi_pMemPort_ARREADY,m_axi_pMemPort_RDATA[31:0],m_axi_pMemPort_RRESP[1:0],m_axi_pMemPort_RLAST,m_axi_pMemPort_RVALID,m_axi_pMemPort_RREADY,vstream_TVALID,vstream_TREADY,vstream_TDATA[23:0],vstream_TKEEP[2:0],vstream_TSTRB[2:0],vstream_TUSER[0:0],vstream_TLAST[0:0],vstream_TID[0:0],vstream_TDEST[0:0],indexw[31:0],indexr[31:0]" */;
