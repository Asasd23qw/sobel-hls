...
architecture behav of Duplicate is 
    ...
    signal t_V_4_reg_125 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    t_V_4_reg_125_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    exitcond_fu_148_p2 <= "1" when (t_V_4_reg_125 = ap_const_lv11_780) else "0";
    ...
    j_V_fu_154_p2 <= std_logic_vector(unsigned(t_V_4_reg_125) + unsigned(ap_const_lv11_1));
