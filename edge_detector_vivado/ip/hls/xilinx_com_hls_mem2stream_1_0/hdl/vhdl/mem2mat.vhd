...
architecture behav of mem2mat is 
    ...
    signal n_fu_241_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal n_reg_288 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWVALID : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWADDR : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_WVALID : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_WDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_WSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_WLAST : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARVALID : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARADDR : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_RREADY : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_BREADY : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_img_data_stream_0_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_img_data_stream_0_V_write : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_img_data_stream_1_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_img_data_stream_1_V_write : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_img_data_stream_2_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_img_data_stream_2_V_write : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_baseAddr_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_baseAddr_ce0 : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_baseAddr_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dataflow_parent_loop_1_fu_193_baseAddr_we0 : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_ap_done : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_ap_start : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_ap_ready : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_ap_idle : STD_LOGIC;
    signal grp_dataflow_parent_loop_1_fu_193_ap_continue : STD_LOGIC;
    signal ap_reg_grp_dataflow_parent_loop_1_fu_193_ap_start : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_sync_reg_grp_dataflow_parent_loop_1_fu_193_ap_ready : STD_LOGIC := '0';
    signal ap_sync_grp_dataflow_parent_loop_1_fu_193_ap_ready : STD_LOGIC;
    signal n_1_fu_253_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_fu_219_p4 : STD_LOGIC_VECTOR (30 downto 0);
    signal icmp_fu_229_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_8_i_fu_235_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_9_i_fu_249_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    grp_dataflow_parent_loop_1_fu_193 : component dataflow_parent_loop_1
    port map (
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_dataflow_parent_loop_1_fu_193_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_reg_grp_dataflow_parent_loop_1_fu_193_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_reg_grp_dataflow_parent_loop_1_fu_193_ap_start <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state3) or ((ap_sync_grp_dataflow_parent_loop_1_fu_193_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state4)))) then 
                    ap_reg_grp_dataflow_parent_loop_1_fu_193_ap_start <= ap_const_logic_1;
                elsif ((grp_dataflow_parent_loop_1_fu_193_ap_ready = ap_const_logic_1)) then 
                    ap_reg_grp_dataflow_parent_loop_1_fu_193_ap_start <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_sync_reg_grp_dataflow_parent_loop_1_fu_193_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_grp_dataflow_parent_loop_1_fu_193_ap_ready <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                    if ((grp_dataflow_parent_loop_1_fu_193_ap_done = ap_const_logic_1)) then 
                        ap_sync_reg_grp_dataflow_parent_loop_1_fu_193_ap_ready <= ap_const_logic_0;
                    elsif ((grp_dataflow_parent_loop_1_fu_193_ap_ready = ap_const_logic_1)) then 
                        ap_sync_reg_grp_dataflow_parent_loop_1_fu_193_ap_ready <= ap_const_logic_1;
                    end if;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((img_cols_V_empty_n = ap_const_logic_0) or (img_rows_V_empty_n = ap_const_logic_0) or (img_cols_V_out_full_n = ap_const_logic_0) or (img_rows_V_out_full_n = ap_const_logic_0) or (w_empty_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, img_rows_V_empty_n, img_cols_V_empty_n, w_empty_n, img_rows_V_out_full_n, img_cols_V_out_full_n, grp_dataflow_parent_loop_1_fu_193_ap_done, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_dataflow_parent_loop_1_fu_193_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, img_rows_V_empty_n, img_cols_V_empty_n, w_empty_n, img_rows_V_out_full_n, img_cols_V_out_full_n)
    begin
                ap_block_state1 <= ((img_cols_V_empty_n = ap_const_logic_0) or (img_rows_V_empty_n = ap_const_logic_0) or (img_cols_V_out_full_n = ap_const_logic_0) or (img_rows_V_out_full_n = ap_const_logic_0) or (w_empty_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(ap_done_reg, grp_dataflow_parent_loop_1_fu_193_ap_done, ap_CS_fsm_state4)
    begin
        if (((grp_dataflow_parent_loop_1_fu_193_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_sync_grp_dataflow_parent_loop_1_fu_193_ap_ready_assign_proc : process(grp_dataflow_parent_loop_1_fu_193_ap_ready, ap_sync_reg_grp_dataflow_parent_loop_1_fu_193_ap_ready)
    begin
        if ((ap_sync_reg_grp_dataflow_parent_loop_1_fu_193_ap_ready = ap_const_logic_0)) then 
            ap_sync_grp_dataflow_parent_loop_1_fu_193_ap_ready <= grp_dataflow_parent_loop_1_fu_193_ap_ready;
        else 
            ap_sync_grp_dataflow_parent_loop_1_fu_193_ap_ready <= ap_const_logic_1;
        end if; 
    end process;
    ...
    grp_dataflow_parent_loop_1_fu_193_ap_continue_assign_proc : process(grp_dataflow_parent_loop_1_fu_193_ap_done, ap_CS_fsm_state4)
    begin
        if (((grp_dataflow_parent_loop_1_fu_193_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
            grp_dataflow_parent_loop_1_fu_193_ap_continue <= ap_const_logic_1;
        else 
            grp_dataflow_parent_loop_1_fu_193_ap_continue <= ap_const_logic_0;
        end if; 
    end process;

    grp_dataflow_parent_loop_1_fu_193_ap_start <= ap_reg_grp_dataflow_parent_loop_1_fu_193_ap_start;
    icmp_fu_229_p2 <= "1" when (signed(tmp_fu_219_p4) < signed(ap_const_lv31_1)) else "0";
    ...
    img_cols_V_out_write_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, img_rows_V_empty_n, img_cols_V_empty_n, w_empty_n, img_rows_V_out_full_n, img_cols_V_out_full_n)
    begin
        if ((not(((img_cols_V_empty_n = ap_const_logic_0) or (img_rows_V_empty_n = ap_const_logic_0) or (img_cols_V_out_full_n = ap_const_logic_0) or (img_rows_V_out_full_n = ap_const_logic_0) or (w_empty_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    img_cols_V_read_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, img_rows_V_empty_n, img_cols_V_empty_n, w_empty_n, img_rows_V_out_full_n, img_cols_V_out_full_n)
    begin
        if ((not(((img_cols_V_empty_n = ap_const_logic_0) or (img_rows_V_empty_n = ap_const_logic_0) or (img_cols_V_out_full_n = ap_const_logic_0) or (img_rows_V_out_full_n = ap_const_logic_0) or (w_empty_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    img_data_stream_0_V_write_assign_proc : process(grp_dataflow_parent_loop_1_fu_193_img_data_stream_0_V_write, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            img_data_stream_0_V_write <= grp_dataflow_parent_loop_1_fu_193_img_data_stream_0_V_write;
        else 
    ...
    img_data_stream_1_V_write_assign_proc : process(grp_dataflow_parent_loop_1_fu_193_img_data_stream_1_V_write, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            img_data_stream_1_V_write <= grp_dataflow_parent_loop_1_fu_193_img_data_stream_1_V_write;
        else 
    ...
    img_data_stream_2_V_write_assign_proc : process(grp_dataflow_parent_loop_1_fu_193_img_data_stream_2_V_write, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            img_data_stream_2_V_write <= grp_dataflow_parent_loop_1_fu_193_img_data_stream_2_V_write;
        else 
    ...
    img_rows_V_out_write_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, img_rows_V_empty_n, img_cols_V_empty_n, w_empty_n, img_rows_V_out_full_n, img_cols_V_out_full_n)
    begin
        if ((not(((img_cols_V_empty_n = ap_const_logic_0) or (img_rows_V_empty_n = ap_const_logic_0) or (img_cols_V_out_full_n = ap_const_logic_0) or (img_rows_V_out_full_n = ap_const_logic_0) or (w_empty_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    img_rows_V_read_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, img_rows_V_empty_n, img_cols_V_empty_n, w_empty_n, img_rows_V_out_full_n, img_cols_V_out_full_n)
    begin
        if ((not(((img_cols_V_empty_n = ap_const_logic_0) or (img_rows_V_empty_n = ap_const_logic_0) or (img_cols_V_out_full_n = ap_const_logic_0) or (img_rows_V_out_full_n = ap_const_logic_0) or (w_empty_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    internal_ap_ready_assign_proc : process(grp_dataflow_parent_loop_1_fu_193_ap_done, ap_CS_fsm_state4)
    begin
        if (((grp_dataflow_parent_loop_1_fu_193_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    m_axi_pMemPort_ARVALID_assign_proc : process(grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_ARVALID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
    ...
    m_axi_pMemPort_RREADY_assign_proc : process(grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_RREADY, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_pMemPort_RREADY <= grp_dataflow_parent_loop_1_fu_193_m_axi_pMemPort_RREADY;
        else 
    ...
    n_1_fu_253_p3 <= 
        index when (tmp_9_i_fu_249_p2(0) = '1') else 
        n_reg_288;
    n_fu_241_p3 <= 
        tmp_8_i_fu_235_p2 when (icmp_fu_229_p2(0) = '1') else 
        ap_const_lv32_0;
    r <= 
        index when (tmp_9_i_fu_249_p2(0) = '1') else 
        n_reg_288;
    ...
    tmp_8_i_fu_235_p2 <= std_logic_vector(unsigned(index) + unsigned(ap_const_lv32_1));
    tmp_9_i_fu_249_p2 <= "1" when (n_reg_288 = w_read_reg_277) else "0";
    tmp_fu_219_p4 <= index(31 downto 1);
    ...
    w_read_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, img_rows_V_empty_n, img_cols_V_empty_n, w_empty_n, img_rows_V_out_full_n, img_cols_V_out_full_n)
    begin
        if ((not(((img_cols_V_empty_n = ap_const_logic_0) or (img_rows_V_empty_n = ap_const_logic_0) or (img_cols_V_out_full_n = ap_const_logic_0) or (img_rows_V_out_full_n = ap_const_logic_0) or (w_empty_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
