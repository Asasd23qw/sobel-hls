...
HD_PWD='F:/ax7020/2017/course_s3_hls/vivado/10_edge_detector/edge_detector.runs/design_1_i2c_extender_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_i2c_extender_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_i2c_extender_0_1.tcl
